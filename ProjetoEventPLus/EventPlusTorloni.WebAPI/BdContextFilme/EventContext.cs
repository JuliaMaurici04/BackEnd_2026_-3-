...
namespace EventPlusTorloni.WebAPI.BdContextFilme;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=EventPlus_Torloni;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ComentarioEvento>(entity =>
        {
            entity.HasKey(e => e.IdComentarioEvento).HasName("PK__Comentar__4305A1F1DBB9597A");
        ...
        {
            entity.HasKey(e => e.IdEvento).HasName("PK__Evento__034EFC04FE637155");
            ...
            entity.HasOne(d => d.InstituicaoNavigation).WithMany(p => p.Eventos).HasConstraintName("FK__Evento__Institui__6D0D32F4");
        });

        modelBuilder.Entity<Instituicao>(entity =>
        {
            entity.HasKey(e => e.IdInstituicao).HasName("PK__Institui__B771C0D8CFF481EF");
        ...
        {
            entity.HasKey(e => e.IdPresenca).HasName("PK__Presenca__50FB6F5D28408111");
        ...
        {
            entity.HasKey(e => e.IdTipoEvento).HasName("PK__TipoEven__CDB3A3BEA266C7D1");
        ...
        {
            entity.HasKey(e => e.IdTipoUsuario).HasName("PK__TipoUsua__CA04062B6DBA4ABB");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF9735ABDB82");
